...
### **[For RTX 3090, 3080/ti, etc.]** Step-by-step installation
...
conda install pytorch==1.8.1  torchvision==0.9.1 cudatoolkit==11.1.1 -c pytorch
...
# the instructions for CUDA 10.1
